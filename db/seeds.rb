...
i1 = Illness.create(covid: "Covid Positive")
i2 = Illness.create(covid: "Covid Negative")
i3 = Illness.create(covid: "Covid Positive")
i4 = Illness.create(covid: "Covid Negative")
i4 = Illness.create(covid: "Covid Negative")
